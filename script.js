...
function mostrarDetalhes(elemento) {
    ...
    switch(elemento) {
        case 'Li':
            conteudo = `
                <h2>Lítio (Li)</h2>
                <p><strong>Número Atómico:</strong> 3</p>
                <p><strong>Função no telemóvel:</strong> Usado nas baterias dos telemóveis.</p>
        ...
        case 'Al':
            conteudo = `
                <h2>Alumínio (Al)</h2>
                <p><strong>Número Atómico:</strong> 13</p>
                <p><strong>Função no telemóvel:</strong> Usado no corpo externo e estrutura dos telemóveis.</p>
        ...
        case 'Cu':
            conteudo = `
                <h2>Cobre (Cu)</h2>
                <p><strong>Número Atómico:</strong> 29</p>
                <p><strong>Função no telemóvel:</strong> Usado nos circuitos elétricos e nas conexões internas.</p>
        ...
        case 'Fe':
            conteudo = `
                <h2>Ferro (Fe)</h2>
                <p><strong>Número Atómico:</strong> 26</p>
                <p><strong>Função no telemóvel:</strong> Componentes estruturais e em algumas ligas.</p>
        ...
        case 'Pb':
            conteudo = `
                ...
                <p><strong>Função no telemóvel:</strong> Usado em algumas baterias mais antigas e componentes de proteção.</p>
        ...
        case 'Ag':
            conteudo = `
                ...
                <p><strong>Função no telemóvel:</strong> Usado nos conectores e circuitos eletrônicos.</p>
        ...
        case 'Au':
            conteudo = `
                ...
                <p><strong>Função no telemóvel:</strong> Utilizado em componentes eletrônicos e contatos.</p>
        ...
        case 'Si':
            conteudo = `
                <h2>Silício (Si)</h2>
                <p><strong>Número Atómico:</strong> 14</p>
                <p><strong>Função no telemóvel:</strong> Usado para compor os chips dos celulares e processadores.</p>
        ...
        case 'Co':
            conteudo = `
                <h2>Cobalto (Co)</h2>
                <p><strong>Número Atómico:</strong> 27</p>
                <p><strong>Função no telemóvel:</strong> Essencial para alimentar nossa tecnologia moderna. O metal é comumente usado para fabricar baterias de iões de lítio, que são encontradas em itens como smartphones.</p>
                <p><strong>Propriedades:</strong> Semimetal, essencial para a eletrônica e tecnologia de semicondutores.</p>
        ...
        case 'Ta':
            conteudo = `
                ...
                <p><strong>Função no telemóvel:</strong> Usado em capacitores, componentes essenciais para a estabilidade e funcionamento da eletrônica.</p>
        ...
        case 'Nd':
            conteudo = `
                ...
                <p><strong>Função no telemóvel:</strong> Um dos elementos do grupo dos lantanídeos, utilizado em ímans para alto-falantes e motores.</p>
                <p><strong>Propriedades:</strong> Lantanídeo, Esses ímans são essenciais em motores elétricos, discos rígidos, auriculares, alto-falantes e até em turbinas eólicas.</p>
        ...
        case 'Zn':
            conteudo = `
                <h2>Zinco (Zn)</h2>
                <p><strong>Número Atómico:</strong> 30</p>
                <p><strong>Função no telemóvel:</strong> Encontrado em alguns circuitos e componentes eletrônicos, além de ser usado no revestimento de outros metais para evitar corrosão.</p>
        ...
        case 'Ti':
            conteudo = `
                <h2>Titânio (Ti)</h2>
                <p><strong>Número Atómico:</strong> 22</p>
                <p><strong>Função no telemóvel:</strong> Usado em algumas ligas para componentes internos e externos devido à sua durabilidade e resistência à corrosão.</p>
